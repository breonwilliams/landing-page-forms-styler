...
class LPFS_Frontend
{
    ...
    public function output_styles()
    {
        ...
        foreach ($presets as $preset) {
            ...
            // Default base styles
            echo ".{$class} label { display:block!important; margin-bottom:0.25rem!important; font-weight:500!important; }\n";
            echo ".{$class} input, .{$class} select, .{$class} textarea, .{$class} button { width:100%!important; padding:0.5rem!important; margin-bottom:1rem!important; border:1px solid #ced4da!important; border-radius:0.375rem!important; font-size:1rem!important; }\n";
            echo ".{$class} input[type=\"radio\"], .{$class} input[type=\"checkbox\"] { width:auto!important; margin-right:0.5rem!important; }\n";
            echo ".{$class} input[type=\"checkbox\"], .{$class} input[type=\"radio\"] { margin-bottom:0!important; }\n";
            echo ".{$class} .form-group { margin-bottom:1rem!important; }\n";
            echo ".{$class} .form-inline { display:flex!important; align-items:center!important; gap:1rem!important; flex-wrap:wrap!important; }\n";
            echo ".{$class} .form-check { display:flex!important; align-items:center!important; margin-bottom:0.5rem!important; }\n";
            echo ".{$class} .form-check input { margin-right:0.5rem!important; }\n";
            echo ".{$class} .form-actions { display:flex!important; gap:1rem!important; }\n";
            echo ".{$class} input[type=\"range\"] { width:100%!important; }\n";
